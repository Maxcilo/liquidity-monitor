...
• 计算公式：RRP + Bank Reserves - TGA

TGA：8382亿，💧 月底释放289亿（预测值：8093亿）

美联储资产负债表：6646.34万亿 🟢 QE进行中（21日 +0.50%）

数据解读：

• RRP极度紧张：当前7.0亿，接近枯竭。这是短期资金市场压力的警示信号。
• 净流动性稳定：7日变化0.1%，维持在2.20万亿。
• TGA释放预期：月底可释放289亿（预测值：8093亿），将增加市场流动性。
